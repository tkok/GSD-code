                ...
                for ( var k in json) {
                    ...
                    for ( var l in json[k].policy.statements) {
                        ...
                        for ( var m in json[k].policy.statements[l].data.conditionalExpressions) {
                            ...
                            //+ json[k].policy.statements[l].data.conditionalExpressions[m].aValue.type
                                + '<input style="width:160px;" class="autocomplete_get required" type="text" id="if-sensorid-' + l + '-' + m + '" name="sensorid" value="' + json[k].policy.statements[l].data.conditionalExpressions[m].sensorId + '">'
                        ...
                        for (var m in json[k].policy.statements[l].data.elseStatements) {
                            ...
                            .prepend('<div id="else-' + json[k].id + '-' + l + '-' + m +'" class="inner_inner_section else"><div><b>else-' + json[k].id + '-' + l + '-' + m +'</b></div>'
                                ...
                                + 'Set: <input style="width:160px;" type="text" class="autocomplete_set required" id="else-sensorid-' + l + '-' + m + '" name="sensorid" value="' + json[k].policy.statements[l].data.elseStatements[m].data.sensorID + '">, '
                    ...
                    $(".statements").delegate(".newif", "click", function (){
                        ...
                        .prepend('<div id="if-' + json[k].id + '-' + n[1] + '-' + ce +'" class="inner_inner_section if"><div><b>if-' + json[k].id + '-' + n[1] + '-' + ce +'</b></div>'
                            ...
                            + '<input class="autocomplete_get required" id="if-sensorid-' + n[1] + '-' + ce + '" style="width:160px;" type="text" name="sensorid" value="' + json[k].policy.statements[n[1]].data.conditionalExpressions[ce].sensorId + '">'
                    ...
                    $(".statements").delegate(".newthen", "click", function (){
                        ...
                        .prepend('<div id="then-' + json[k].id + '-' + n[1] + '-' + ts +'" class="inner_inner_section then"><div><b>then-' + json[k].id + '-' + n[1] + '-' + ts +'</b></div>'
                        		 + 'Set: <input style="width:160px;" type="text" id="then-sensorid-' + n[1] + '-' + ts + '" class="autocomplete_set required" name="sensorid" value="' + json[k].policy.statements[n[1]].data.thenStatements[ts].data.sensorID + '">, '
                    ...
                    $(".statements").delegate(".newelse", "click", function (){
                        ...
                        .prepend('<div id="else-' + json[k].id + '-' + n[1] + '-' + es +'" class="inner_inner_section else"><div><b>else-' + json[k].id + '-' + n[1] + '-' + es +'</b></div>'
                        		 + 'Set: <input style="width:160px;" type="text" id="else-sensorid-' + n[1] + '-' + es + '" class="autocomplete_set required" name="sensorid" value="' + json[k].policy.statements[n[1]].data.elseStatements[es].data.sensorID + '">, '
            ...
            function recursiveThen(json, k, l, m)
            {
                ...
                if (json[k].policy.statements[l].data.thenStatements[m].type == "dk.itu.policyengine.domain.IfStatement") {
                    ...
                    .prepend('<div id="then-' + json[k].id + '-' + l + '-' + m +'" class="inner_inner_section then"><div><b>then-' + json[k].id + '-' + l + '-' + m +'</b></div>'
                        ...
                        + 'Set: <input style="width:160px;" type="text" class="autocomplete_set required" id="then-sensorid-' + l + '-' + m + '" name="sensorid" value="' + json[k].policy.statements[l].data.thenStatements[m].data.sensorID + '">, '
