...
public class IfStatement_IntValue_Not_Test {
	...
	public void simpleEqual_ExecuteBecauseLT() {
		Expression expression = new Expression(ROOM1_TEMPERATURE, Operator.NOT, new IntValue(10));
	...
	public void simpleEqual_ExecuteBecauseGT() {
		Expression expression = new Expression(ROOM1_TEMPERATURE, Operator.NOT, new IntValue(12));
		Statement thenStatement = new SetStatement(ROOM1_HEATER, new BooleanValue(true));
	...
	public void simpleEquak_NoExecuteEqual() {
		Expression expression = new Expression(ROOM1_TEMPERATURE, Operator.NOT, new IntValue(11));
		Statement thenStatement = new SetStatement(ROOM1_HEATER, new BooleanValue(true));
